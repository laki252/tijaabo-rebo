...
DEFAULT_GEMINI_KEYS = "AIzaSyADfan-yL9WdrlVd3vzbCdJM7tXbA72dG,AIzaSyAKrnVxMMPIqSzovoUggWzXy5CQ_4Hi7I_NU,AIzaSyD0sYw4zzlXhbSV3HLY9wM4zCqX8ytR8zQ"
...
def convert_to_mp3(input_file: str) -> str:
    ...
    try:
        ...
        raise RuntimeError(f"FFMPEG failed to convert file to MP3: {e}")
    ...
    try:
        ...
        for chunk in chunks:
            ...
            if length_ms <= max_chunk_ms:
                ...
                # Tijaabada FLAC: Kordhin ahaan u isticmaal .flac, qaab ahaan u dhoofi FLAC
                chunk_file = os.path.join(DOWNLOADS_DIR, f"{os.path.basename(mp3_path)}_chunk{chunk_index}.flac")
        ...
        for i, chunk_file in enumerate(tmp_files, 1):
            ...
            # Isticmaal sr.AudioFile oo leh fayl .flac ah
        ...
        return f"Error: Qalad weyn oo tijaabo cilmiyeed ah: {e}"
    finally:
